...
struct mydsp : public dsp {
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = std::tan(42411.5f / fConst0);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("LP_33");
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp1 = ((iTemp0) ? 0.0f : fConst6 + fRec2[1]);
			fRec2[0] = fTemp1 - std::floor(fTemp1);
			float fTemp2 = ((iTemp0) ? 0.0f : fConst7 + fRec3[1]);
			fRec3[0] = fTemp2 - std::floor(fTemp2);
			fRec0[0] = fVec1[(IOTA0 - static_cast<int>(std::min<float>(4096.0f, std::max<float>(0.0f, 1e+03f * (0.00065f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec3[0]), 65535))] + 0.00014f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec2[0]), 65535))] + 1.0f))))) & 1023] - fConst5 * (fConst4 * fRec0[2] + fConst2 * fRec0[1]);
			...
			float fTemp3 = 0.049922034f * fRec6[0] + 0.0506127f * fRec6[2] - (0.095993534f * fRec6[1] + 0.004408786f * fRec6[3]);
			fVec3[0] = fTemp3;
			fRec5[0] = fConst12 * (fConst11 * (fTemp3 - fVec3[1]) - fConst10 * fRec5[1]);
			fRec4[0] = -(fConst15 * (fConst14 * fRec4[1] - (fRec5[0] + fRec5[1])));
			float fTemp4 = ((iTemp0) ? 0.0f : fConst16 + fRec8[1]);
			fRec8[0] = fTemp4 - std::floor(fTemp4);
			output0[i0] = static_cast<FAUSTFLOAT>(tanhf(0.9545f * (0.0015f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec8[0]), 65535))] + fRec4[0] + fConst5 * (fRec0[2] + fRec0[0] + 2.0f * fRec0[1]))));
			iVec0[1] = iVec0[0];
			IOTA0 = IOTA0 + 1;
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
	...
	#define FAUST_FILE_NAME "LP_33.dsp"
...
LP_33::LP_33() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void LP_33::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void LP_33::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float LP_33::getParamValue(const std::string& path)
{
